...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			strong1.textContent = `${/*age*/ ctx[0]} year old`;
    			t7 = space();
    			p2 = element("p");
    			...
    			add_location(p0, file$3, 11, 16, 287);
    			attr_dev(strong0, "class", "highlight svelte-1z0ssww");
    			add_location(strong0, file$3, 12, 30, 331);
    			attr_dev(strong1, "class", "highlight svelte-1z0ssww");
    			add_location(strong1, file$3, 12, 82, 383);
    			add_location(p1, file$3, 12, 16, 317);
    			add_location(p2, file$3, 13, 16, 453);
    			attr_dev(strong2, "class", "highlight svelte-1z0ssww");
    			add_location(strong2, file$3, 14, 28, 501);
    			attr_dev(strong3, "class", "highlight svelte-1z0ssww");
    			add_location(strong3, file$3, 14, 74, 547);
    			add_location(p3, file$3, 14, 16, 489);
    			attr_dev(h1, "class", "svelte-1z0ssww");
    			add_location(h1, file$3, 10, 12, 266);
    			attr_dev(section, "id", "body");
    			attr_dev(section, "class", "svelte-1z0ssww");
    			add_location(section, file$3, 9, 0, 234);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Flex, birth, current, diff, age });
