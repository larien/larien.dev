(function (global, factory) {
    ...
    (global = global || self, global.Flex = factory());
    ...
    /* src/Flex.svelte generated by Svelte v3.20.1 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", div_class_value = "" + (null_to_empty(/*className*/ ctx[0]) + " svelte-f66dpe"));
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*className*/ 1 && div_class_value !== (div_class_value = "" + (null_to_empty(/*className*/ ctx[0]) + " svelte-f66dpe"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*direction, reverse, align, justify*/ 30) {
    	...
    	return [className, direction, align, justify, reverse, $$scope, $$slots];
    }

    class Flex extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-f66dpe-style")) add_css();
